...
with open('plos_llama3_lora_finetuned_top1_responses_5-5_try2.txt', 'w') as f:
...
for i in tqdm(range(len(plos_test))):
    ...
    with open('plos_llama3_lora_finetuned_top1_responses_5-14_max_token256_topshot_temp099.txt', 'a') as f:
        f.write(response + '\n')
